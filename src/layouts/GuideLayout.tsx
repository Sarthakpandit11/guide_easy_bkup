...
import { Menu, X, Calendar, MessageSquare, LogOut, User, Lock } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-gray-100 dark:bg-gray-900">
      ...
      <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-gray-800 transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col h-screen ${
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
          <Link to="/guide/dashboard" className="text-xl font-bold text-gray-800 dark:text-white">
            Guide Portal
          </Link>
          <button 
            ...
            <div className="flex justify-between h-16">
              <div className="flex items-center">
                ...
                <h1 className="text-xl font-semibold text-gray-800 dark:text-white">
                  {location.pathname === '/guide/dashboard' ? 'Dashboard' :
                   location.pathname === '/guide/profile' ? 'Profile' :
                   location.pathname === '/guide/bookings' ? 'Bookings' :
                   location.pathname === '/guide/messages' ? 'Messages' :
                   'Guide Portal'}
                </h1>
              </div>
